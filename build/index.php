...
<body id="top">
    ...
    <section class="cd-hero" id="top-slider">
        <ul class="cd-hero-slider autoplay">
            <li class="selected first-slide" style="background-image:url(img/slides/2.jpg)">
            ...
            <li class="cd-bg-video" style="background-image:url(img/slides/2.jpg)">
                <div class="overlay"></div>
                <div class="slider-content slider-content-full">
            ...
            <li class="cd-bg-video" style="background-image:url(img/slides/3.jpg)">
                <div class="overlay"></div>
                <div class="slider-content slider-content-full">
                    <div class="caption caption-left">
            ...
            <li style="background-image:url(img/int/chetverg-1.jpg)">
                <div class="overlay"></div>
                <div class="slider-content slider-content-full">
                    <div class="caption caption-left">
            ...
            <li style="background-image:url(img/slides/2.jpg)">
                <div class="overlay"></div>
                <div class="slider-content slider-content-full">
                    <div class="caption caption-left">
            ...
            <li style="background-image:url(img/slides/3.jpg)">
                <div class="overlay"></div>
                <div class="slider-content slider-content-full">
                    <div class="caption caption-left">
                        <div class="svg-logo logo-shale">
    ...
    <section class="section-background section-padding parallax-background" style="background-image: url(img/fish/1.jpg)" id="fish-bonus">
        <div class="container">

            <div class="col-md-6 text-center">
                <h2>Две рыбы по цене одной</h2>
                <p>Центр коммуникативных технологий Дегтярева» основан в 2000 году. Основные тренинги и мастер-классы: Навыки эффективных бизнес-коммуникаций. Искусство убеждения. Технологии эффективных переговоров. Техника профессиональных продаж</p>
<!--                 <div class="down-arrow floating-arrow"><a href="#"><i class="fa fa-angle-down"></i></a></div> -->
    ...
    <section class="section-background section-padding parallax-background" style="background-image: url(img/int/vostok-2.jpg)" id="something">
        <div class="container">
            <div class="col-md-6 text-center">
                <h2>М-Вкусно &mdash; доставка</h2>
                <p>Тесные партнерские отношения с ведущими производителями позволяют нам предлагать нашим покупателям самую качественную и
                из первых узнавать об инициативах компаний-партнеров.</p>
            </div>
            <div class="col-md-6 text-center">
                <div class="logo-placeholder svg-drawing floating-logo logo-background">
                    <? includeSVG("line/cart.svg"); ?>
                 <div class="down-arrow floating-arrow"><a href="#section-content"><span class="fa fa-angle-down"></span></a></div>
                </div>
            </div>
        </div>
        <div class="overlay"></div>
    ...
    <section class="section-padding section-gray section-content" style="padding: 100px 0" id="section-content">
        <div class="container">
            <h3>Подаваемые блюда отличного качества.</h3>
