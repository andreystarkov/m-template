...
<body id="top">
    ...
    <section class="section-background section-padding background-parallax" style="background-image: url(img/sample/food.jpg)" id="fish-bonus">
        <div class="container">

            <div class="col-md-6 text-center">
                <h2>Более подробная версия меню</h2>
                <p>Центр коммуникативных технологий Дегтярева» основан в 2000 году. И снова всё по новой, щупальце каракатицы и соус с элементами коралловых водорослей!</p>
            </div>
            <div class="col-md-6 text-center">
                <div class="logo-placeholder-big floating-logo logo-background">
                <svg id="icon-fishwine" class="icon-fish" viewBox="0 0 400 400">
    ...
    <section class="section-background section-padding background-parallax" style="background-image: url(img/int/vostok-1.jpg" id="menu-list-header">
        <div class="container">
            <div class="col-md-6 text-center">
                <h2>Ознакомтесь с нашим невероятным меню</h2>
                <p>Вкуснее только в космосе, а вообще пшеничные булочки в плетеной корзиночке, которые можно обмакнуть в пикантный соус из оливкового масла и бальзамического уксуса,</p>
